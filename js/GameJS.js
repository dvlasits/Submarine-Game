...
function preload() {
  ...
  redBinNoArrow = new Sprite("img/gameImages/redBinNoBackground.png");
  yellowBinNoArrow = new Sprite("img/gameImages/yellowBinNoArrow.png");
  greenBinNoArrow = new Sprite("img/gameImages/greenBinNoArrow.png");
  blueBinNoArrow = new Sprite("img/gameImages/blueBinNoArrow.png");
  ...
  if(level>0 && level < 6) {
    ...
    rubbishSpeed = -200 - (level-10) * 100
    shipSpeed = 200 + (level-10) * 100
    ObsFreq = 2000 - (level-9) * 200
    TraFreq = 3000 - (level-9) * 200
    ultimate = true
    var toggled = 0;
    var starting = 5;
    start = game.getGameTime() + 7000
  }
}
...
function update() {
  if (ultimate && game.getGameTime() > start){
    if (toggled == 0){
      redBinNoArrow.create(50+125,25,100,100)
      yellowBinNoArrow.create(50+3*125,25,100,100)
      greenBinNoArrow.create(50+2*125,60,100,70)
      blueBinNoArrow.create(50,25,100,100)
      toggled = 1;
    }
